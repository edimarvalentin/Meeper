...
**Meeper** is an android app that allows a user to view his Twitter timeline of only the followed users. The app utilizes [Twitter REST API](https://dev.twitter.com/rest/public).
...
- [x] User can see the amount of retweets (remeeps) of a meep
- [x] User can see the amount of likes of a meep
...
<img src='https://edimarvalentin.me/img/MeeperPreview.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
